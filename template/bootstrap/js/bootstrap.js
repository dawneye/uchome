  ...
  * ================= */
  ...
  jQuery(function () {
    jQuery('body').on('click.carousel.data-api', '[data-slide]', function ( e ) {
	  ...
	  if($target.length<1)$target=$this.parent();
      var options = !$target.data('modal') && jQuery.extend({}, $target.data(), $this.data())
...
!function ($) {
  ...
  * ========================= */
  ...
  , keydown: function (e) {
      ...
      $items = jQuery('[role=menu] li:not(.divider) a', $parent)
  ...
  Modal.prototype = {
    ...
    , show: function () {
        ...
        this.backdrop(function () {
          ...
          transition ?
            that.$element.one(jQuery.support.transition.end, function () { that.$element.trigger('shown') }) :
...
!function ($) {
  ...
  * ====================== */
  ...
  var Affix = function (element, options) {
    ...
    this.$window = jQuery(window).on('scroll.affix.data-api', jQuery.proxy(this.checkPosition, this))
    this.$element = jQuery(element)
    this.checkPosition()
  }
