...
function ajaxmenu(e, ctrlid, isbox, timeout, func) {
	...
	x.get(href, function(s) {
		...
		if(s.indexOf('hideMenu()') == -1) {//添加关闭
			s = '<h5 class="title modal-header">消息<a href="javascript:hideMenu();" class="float_del pull-right" title="关闭">关闭</a></h5><div class="popupmenu_inner modal-body">' + s + '</div><div class="modal-footer"><a href="javascript:hideMenu();" class="btn">取消</a></div>';
		}
		if(!evaled) {
